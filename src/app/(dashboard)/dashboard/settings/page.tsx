              ...
              <div className="bg-neutral-50 border border-neutral-200 rounded-xl p-5 mb-5">
                ...
                <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3 mb-3">
                  <p className="text-xs text-emerald-700">
                    <strong>🔒 100% gratuito y seguro.</strong> Crear tu cuenta
                    en Stripe no tiene ningún coste. Stripe es la plataforma de
                    pagos que usan empresas como Amazon, Google y Shopify. Tus
                    datos están protegidos con cifrado bancario.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-neutral-500">
                        Stripe te pedirá un <strong>teléfono móvil</strong> para
                        verificar tu identidad con un código SMS.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-neutral-500">
                        ...
                        Exactamente como aparecen en tu <strong>DNI/NIE</strong>
                        .
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-neutral-500">
                        ...
                        <strong>foto de tu DNI/NIE</strong> (anverso y reverso).
                ...
                <div className="mt-3 bg-amber-50 border border-amber-200 rounded-lg p-3">
                  <p className="text-xs text-amber-700">
                    <strong>⏱️ ¿Cuánto tarda?</strong> El proceso completo lleva
                    unos <strong>5-10 minutos</strong>. Si lo dejas a medias,
                    puedes retomarlo volviendo a pulsar el botón.
                  </p>
                </div>
              </div>
