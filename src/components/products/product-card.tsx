...
export function ProductCard({
  ...
  return (
    <Link
      ...
      className={`group relative bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-200 hover:-translate-y-1 active:scale-95 active:opacity-80${boosted ? " ring-2 ring-flamencalia-albero/40 glass-shine" : ""}`}
    >
