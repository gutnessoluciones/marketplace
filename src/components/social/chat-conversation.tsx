  ...
  return (
    <div className="flex flex-col h-[calc(100vh-8rem)] max-w-2xl mx-auto">
      ...
      <div className="flex-1 overflow-y-auto py-6 space-y-4 scrollbar-thin">
        {/* Admin review notice */}
        <div className="flex items-center gap-2 px-3 py-2 bg-flamencalia-cream/60 border border-flamencalia-albero-pale/20 rounded-xl text-[11px] text-flamencalia-black/40 mx-auto max-w-sm text-center justify-center">
          <svg
          ...
          <span>
            Esta conversación puede ser revisada por los administradores de
            Flamencalia
          </span>
        </div>
